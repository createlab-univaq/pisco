            ...
            >
                <div class="edit-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="firstName" name="firstName" value={patient.firstName} required class="dropdown" />
                    </div>
                    <div class="form-group">
                        <label for="lastName">Cognome</label>
                        <input type="text" id="lastName" name="lastName" value={patient.lastName} required class="dropdown" />
                    </div>
                </div>
                <div class="edit-row">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="age" name="age" value={patient.age} required class="dropdown" />
                    </div>
                    <div class="form-group">
                ...
                <div class="edit-actions">
                    ...
                    <button type="button" class="btn btn-secondary" onclick={() => (editPatientMode = false)}>Annulla</button>
                    ...
                    <button 
                        ...
                        onclick={(e) => {
                            if(!confirm('Sei sicuro di voler eliminare questo paziente? L\'azione è irreversibile.')) e.preventDefault();
                        }}
                    >
                        Elimina Paziente
                    </button>
        ...
        {:else}
            ...
            <div class="patient-header">
                ...
                <div class="export-controls">
                    <button class="btn btn-secondary" style="border-color: #ddd;" onclick={() => (editPatientMode = true)}>
                        ✏️ Modifica Dati
                    </button>
