...
import { TeoriaDellaMenteNode } from '../../../types/polyglotElements';
import Card from '../../Card/Card';
import { ReactFlowNodeProps } from '../ReactFlowNode';

type Props = ReactFlowNodeProps & TeoriaDellaMenteNode;

const ReactFlowTeoriaDellaMenteNode = ({ id }: Props) => {
...
export default ReactFlowTeoriaDellaMenteNode;
