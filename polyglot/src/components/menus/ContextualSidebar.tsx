            ...
            <div className={styles.content}>
                <div className={styles.header}>
                    ...
                    <button
                        ...
                        onClick={() => isShowingProperties ? onClearSelection() : setIsCollapsed(true)}
                        title="Close"
                    >
                        <svg className={styles.icon} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
                    </button>
                </div>
