...
const QuestionEditor = ({ question, index, allQuestions, onChange, onRemove }: any) => {
...
const StoryEditor = ({ story, index, onChange, onRemove }: { story: FauxPasExerciseAQuizItem, index: number, onChange: (s: FauxPasExerciseAQuizItem) => void, onRemove: () => void }) => {
    ...
    return (
        <div className={styles.storyCard}>
            ...
            {/* Independent Explanation Field per Story */}
            <TextField
                label="Explanation"
                name={`story-${index}-explanation`}
