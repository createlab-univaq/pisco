...
export const validateEmotionAttributionBNode = (data: any): ValidationError[] => {
    const allowedEmpty = ['explanation'];
    const errors: ValidationError[] = validateGenericStrict('EmotionAttributionBNode', data, allowedEmpty);
