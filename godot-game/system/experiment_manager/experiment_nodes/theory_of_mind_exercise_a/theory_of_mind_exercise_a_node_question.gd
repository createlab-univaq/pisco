...
func _init(p_text: String, p_is_first: bool, p_is_last: bool, p_image_id: String, p_caption: String, p_choices: Array[String], p_correct_answer_index: int, p_explanation: String) -> void:
	self.text = p_text
