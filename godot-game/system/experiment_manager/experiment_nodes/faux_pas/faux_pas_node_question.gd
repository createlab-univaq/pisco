...
func _init(p_text: String, p_is_first: bool, p_is_last: bool, p_narration: String, p_correct_question_index: int, p_choices: Array[String], p_skip_question: FauxPasSkipQuestion) -> void:
	self.text = p_text
